...
def btnClick(buttons):
   ...
   if buttons["text"] == " " and bclick == True:
       ...
       tkinter.messagebox.showinfo("X O", "Button already Clicked!")
...
def checkForWin():
   if (button1['text'] == 'X' and button2['text'] == 'X' and button3['text'] == 'X' or
       ...
       disableButton()
       tkinter.messagebox.showinfo("X O", pa)

   elif(flag == 8):
       tkinter.messagebox.showinfo("X O", "It is a Tie")
       ...
       disableButton()
       tkinter.messagebox.showinfo("X O", playerb)
